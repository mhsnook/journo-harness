/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f2ab645435570ecd850acee12a99d7bc)
// Runtime types generated with workerd@1.20260801.1 2026-08-06 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	ArticleAgent: DurableObjectNamespace<import("./src/server/index").ArticleAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "ArticleAgent";
	}
